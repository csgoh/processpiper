...
# Connect all the elements
    ...
    text2diagram.render(diagram_str, "images/test/test_sample12.png", show_code=True)
...
# Connect all the elements
    ...
    text2diagram.render(diagram_str, "images/test/test_sample13.svg", show_code=True)
